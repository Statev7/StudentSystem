        ...
        public readonly static object[][] ParametersWithInvalidLessonId =
{
        ...
        [Theory, MemberData(nameof(ValidParametersToUpdate))]
        public void PostUpdateShouldUpdateLesson(
            int id,
            string title,
            string content,
            string begining,
            ...
            =>
                MyMvc
                    ...
                    .ShouldMap(request => request
                        ...
                        .WithUser(new[] { ADMIN_ROLE })
                        .WithAntiForgeryToken())
                    .To<LessonsController>(c => c.Update(id, new LessonFormServiceModel
                    {
                        Title = title,
                        Content = content,
        ...
        [Theory, MemberData(nameof(InvalidModelStateParametersForUpdate))]
        ...
        [Theory, MemberData(nameof(ParametersWithInvalidLessonId))]
        public void PostUpdateShouldRedirectIfLessonNotExist(
            int id,
            string title,
            string content,
            string begining,
